...
namespace API_Restaurant.Migrations
{
    ...
    [Migration("20240517173309_update_new_attr_halls_img_222")]
    partial class update_new_attr_halls_img_222
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Restaurant.Data.Model.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Restaurant.Data.Model.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Restaurant.Data.Model.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Restaurant.Data.Model.Order", b =>
                {
                    ...
                    b.HasOne("API_Restaurant.Data.Model.Status", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("API_Restaurant.Data.Model.OrderItem", b =>
                {
                    b.HasOne("API_Restaurant.Data.Model.Dish", "Dish")
                        .WithMany()
                        .HasForeignKey("DishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_Restaurant.Data.Model.Order", "Order")
                        .WithMany()
